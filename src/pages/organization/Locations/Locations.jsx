    ...
    <div className="pb-3 relative px-2">
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          ...
          <button className="ml-2 mr-2 w-5 h-5 mt-4 rounded bg-gray-100 shadow-none text-gray-700 text-lg flex justify-center items-center dark:border-none dark:bg-[#333] dark:text-light">
        ...
        <div className="flex items-center">
          ...
          <div className="relative inline-block">
            ...
            <button
              ...
              className="relative border border-gray-300 bg-gray-100 px-6 py-2 text-gray-700 flex items-center dark:border-none dark:bg-[#333] dark:text-light rounded-md"
            >
              All Locations
