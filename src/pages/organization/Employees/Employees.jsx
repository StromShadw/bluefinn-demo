    ...
    <div className="pb-3 relative px-2">
      <div className="flex justify-between items-center">
        <div className="flex items-center ">
          ...
          <button className="ml-2 mr-2 w-5 h-5 mt-4 rounded shadow-none text-gray-700 text-lg flex justify-center items-center dark:border-none dark:text-light">
            <HiDotsHorizontal className="w-4 h-4" />
          </button>
        </div>
        <div className="flex w-5 h-5 mr-6">
          <button className="ml-1 dark:border-none dark:bg-[#333] dark:text-light rounded-sm">
      ...
      <div className="flex justify-between items-center py-3 px-8">
        <div className="flex items-center">
          <div className="text-xl font-medium text-gray-700 mr-2">
            Employees
          </div>
          <div className="relative inline-block">
            ...
            <button
              ...
              className="relative border border-gray-300 bg-gray-100 px-6 py-2 text-gray-700 flex items-center dark:border-none dark:bg-[#333] dark:text-light rounded-md dark:border-none dark:bg-[#333] dark:text-light"
            >
              All Employees
